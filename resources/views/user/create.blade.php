...
@section('konten')
    ...
    <div class="container-fluid">
        ...
        @if (isset($_GET['jenis']) && $_GET['jenis'] === 'akademik')
            <h1 class="h3 mb-4 text-gray-800">Daftar Beasiswa Akademik</h1>
        @elseif(isset($_GET['jenis']) && $_GET['jenis'] === 'nonakademik')
            <h1 class="h3 mb-4 text-gray-800">Daftar Beasiswa Non Akademik</h1>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="no_hp" name="nomor_hp"
                                    placeholder="Nomor HP" value="{{ old('nomor_hp') }}" required>
                                @error('no_hp')
                                    <label class="text-danger">{{ $message }}</label>
                                @enderror
                            </div>
                    ...
                    <div class="card-footer">
                        <div class="my-3 text-center align-content-center">
                            <input type="submit" value="Daftar" id="submit"
                                class="btn btn-primary btn-md text-center" disabled />
